    ...
    case "success":
      return (
        <div className="space-y-form-gap">
          ...
          <div className="bg-green-50 p-4 rounded-form border border-green-200 mb-4">
    ...
    case "pending":
      return (
        <div className="space-y-form-gap">
          ...
          <div className="bg-blue-50 p-4 rounded-form border border-blue-200 mb-4">
            <div className="flex items-center mb-2">
              <svg
    ...
    case "submitting":
      return (
        <div className="space-y-form-gap">
          ...
          <div className="bg-yellow-50 p-4 rounded-form border border-yellow-200 mb-4">
            <div className="flex items-center mb-2">
              <svg
    ...
    case "error":
      return (
        <div className="space-y-form-gap">
          ...
          <div className="bg-red-50 p-4 rounded-form border border-red-200 mb-4">
            <div className="flex items-center mb-2">
              <svg
    ...
    default: // idle state - show the form
      return (
        <div className="space-y-form-gap">
          ...
          {errorMessage && (
            <div className="bg-red-50 p-3 rounded-form border border-red-200">
